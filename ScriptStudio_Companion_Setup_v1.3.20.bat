...
set "EXE_NAME=ScriptStudioCompanion_v1.3.20.exe"
set "DOWNLOAD_URL=https://scriptstudio-web.pages.dev/ScriptStudioCompanion_v1.3.20.exe"
if not exist "%INSTALL_DIR%" mkdir "%INSTALL_DIR%"
echo Stopping all Companion versions...
wmic process where "name like 'ScriptStudioCompanion%%'" delete >nul 2>&1
echo Stopping old flow workers...
...
echo Starting Companion v1.3.20...
start "" "%INSTALL_DIR%\%EXE_NAME%"
echo.
echo Done! Companion v1.3.20 is running in background.
pause
