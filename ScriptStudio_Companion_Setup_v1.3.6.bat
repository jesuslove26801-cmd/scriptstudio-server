...
echo.
echo =================================================
echo   ScriptStudio Companion Setup v1.3.6
echo =================================================
echo.
...
curl.exe -L --output "D:\ScriptStudio\Companion\ScriptStudioCompanion.exe" "https://scriptstudio-web.pages.dev/ScriptStudioCompanion_v1.3.6.exe"
