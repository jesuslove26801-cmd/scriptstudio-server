...
set "EXE_NAME=ScriptStudioCompanion_v1.3.11.exe"
set "DOWNLOAD_URL=https://scriptstudio-web.pages.dev/ScriptStudioCompanion_v1.3.11.exe"
...
echo Starting Companion v1.3.11...
start "" "%INSTALL_DIR%\%EXE_NAME%"
echo.
echo Done! Companion v1.3.11 is running in background.
pause
