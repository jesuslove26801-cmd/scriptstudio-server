...
set "EXE_NAME=ScriptStudioCompanion_v1.3.18.exe"
set "DOWNLOAD_URL=https://scriptstudio-web.pages.dev/ScriptStudioCompanion_v1.3.18.exe"
...
echo Starting Companion v1.3.18...
start "" "%INSTALL_DIR%\%EXE_NAME%"
echo.
echo Done! Companion v1.3.18 is running in background.
pause
